...
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Load_Graph_Prompt',@language = 'En', @ref_desc = 'Your graph has unsaved changes. Continue load?'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Load_Graph_Prompt',@language = 'Fr', @ref_desc = 'Fr: Your graph has unsaved changes. Continue load?'
