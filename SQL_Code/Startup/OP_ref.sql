...
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Reset_Dashboard_All_Unsaved_Changes_will_Be_Lost',@language = 'Fr', @ref_desc = 'Fr: Reset dashboard all unsaved changes will be lost'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_X_Axis_Measure',@language = 'En', @ref_desc = 'X-Axis Measure'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_X_Axis_Measure',@language = 'Fr', @ref_desc = 'Fr: X-Axis Measure'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Y_Axis_Measure',@language = 'En', @ref_desc = 'Y-Axis Measure'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Y_Axis_Measure',@language = 'Fr', @ref_desc = 'Fr: Y-Axis Measure'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Size',@language = 'En', @ref_desc = 'Size'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Size',@language = 'Fr', @ref_desc = 'Fr: Size'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Size_Measure',@language = 'En', @ref_desc = 'Size Measure'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Size_Measure',@language = 'Fr', @ref_desc = 'Fr: Size Measure'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Animate_Over_Time',@language = 'En', @ref_desc = 'Animate Over Time'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Animate_Over_Time',@language = 'Fr', @ref_desc = 'Fr: Animate Over Time'
GO
