...
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Measure_Id',@language = 'En', @ref_desc = 'Measure Id'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Measure_Id',@language = 'Fr', @ref_desc = 'Identifiant de la mesure'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Measure_Fcn',@language = 'En', @ref_desc = 'Measure Function'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Measure_Fcn',@language = 'Fr', @ref_desc = 'Fonction de mesure'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_MeasQual1',@language = 'En', @ref_desc = 'Measure Qual1'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_MeasQual1',@language = 'Fr', @ref_desc = 'Mesurer la qualité 1'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_MeasQual2',@language = 'En', @ref_desc = 'Measure Qual2'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_MeasQual2',@language = 'Fr', @ref_desc = 'Mesurer la qualité 2'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Comment',@language = 'En', @ref_desc = 'Comment'
EXEC InsertOPRef @ref_table = 'Labels', @ref_value = 'LBL_Comment',@language = 'Fr', @ref_desc = 'Commenter'
GO
