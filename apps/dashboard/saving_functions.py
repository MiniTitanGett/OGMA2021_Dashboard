...
def load_graph_menu(graph_type, tile, df_name, args_list, axes_title, axes_modified, df_const):
    if graph_type == 'Line' or graph_type == 'Scatter':
        graph_menu = get_line_scatter_graph_menu(tile=tile, x=args_list[0], y=args_list[2], measure_type=args_list[1],
                                                 ...
                                                 xpos=axes_title[2], ypos=axes_title[3], xmodified=axes_modified[0],
                                                 ymodified=axes_modified[1], df_name=df_name, df_const=df_const)
    elif graph_type == 'Bar':
        graph_menu = get_bar_graph_menu(tile=tile, x=args_list[0], y=args_list[2], measure_type=args_list[1],
                                        ...
                                        xmodified=axes_modified[0], ymodified=axes_modified[1], xpos=axes_title[2],
                                        ypos=axes_title[3], df_const=df_const)
        ...
        graph_menu = get_table_graph_menu(tile=tile, number_of_columns=args_list[1], xaxis=axes_title[0],
                                          ...
                                          xmodified=axes_modified[0], ymodified=axes_modified[1],)
        ...
        graph_menu = get_bubble_graph_menu(tile=tile, x=args_list[0], x_measure=args_list[1], y=args_list[2],
                                           ...
                                           yaxis=axes_title[1],  df_name=df_name, df_const=df_const, xpos=axes_title[2],
                                           ypos=axes_title[3], xmodified=axes_modified[0], ymodified=axes_modified[1],)
    else:
        raise PreventUpdate
